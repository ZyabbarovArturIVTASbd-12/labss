...
<body>
    <div class="page">
        <div class="user">
            <img alt="User Avatar" class="user_avatar">
            <div class="user_info">
                <span class="user_name"></span>
                <span class="user_location"></span>
            </div>
        </div>
        <div class="name-form">
            <input type="text" placeholder="Введите имя пользователя"  class="name-form_input">
            <button class="name-form_btn btn">Показать</button>
        </div>
    </div>
    <script src="./script/negame.js"></script>
</body>
